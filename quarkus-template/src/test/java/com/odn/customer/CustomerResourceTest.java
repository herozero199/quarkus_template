...
//
//import com.odn.TestSecurityAuthTest;
//import com.odn.exception.ExceptionResponse;
...
//                .headers("Authorization", "Bearer " + TestSecurityAuthTest.getToken())
...
//                .isNotNull()
//                .hasSize(1)
//                .contains(new ExceptionResponse.ErrorMessage("post.customer.firstName", getErrorMessage("Customer.firstName.required")));
//    }
//
//    @Test
...
//                .hasSize(3)
//                .contains(
//                        new ExceptionResponse.ErrorMessage("post.customer.firstName", getErrorMessage("Customer.firstName.required")),
//                        new ExceptionResponse.ErrorMessage("post.customer.lastName", getErrorMessage("Customer.lastName.required")),
//                        new ExceptionResponse.ErrorMessage("post.customer.email", getErrorMessage("Customer.email.invalid"))
//                );
//    }
//
//    @Test
...
//                .isNotNull()
//                .hasSize(1)
//                .contains(new ExceptionResponse.ErrorMessage("put.customer.lastName", getErrorMessage("Customer.lastName.required")));
//    }
//
